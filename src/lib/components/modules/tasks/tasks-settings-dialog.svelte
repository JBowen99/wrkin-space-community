...
<Dialog bind:open title="Task module settings" onOpenChange={(value) => !value && handleClose()}>
	...
	>
		<fieldset class="space-y-2">
			<legend class="text-sm font-medium text-ink">Color tasks by</legend>
			<RadioGroup
				name="colorBy"
				bind:value={colorBy}
		...
		<div class="space-y-3">
			<p class="text-sm font-medium text-ink">Status colors</p>
		...
		<div class="space-y-3">
			<p class="text-sm font-medium text-ink">Priority colors</p>
			<div class="grid gap-2 sm:grid-cols-2">
