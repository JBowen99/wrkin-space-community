...
import { chatMessage, chatMessageAttachment, wrkspaceModule } from './db/schema.ts';
...
import { chatAttachmentKey, deleteObject, getObject, putObject } from './storage/index.ts';
import {
...
export async function userCanAccessChatMessage(
	...
	const { userCanAccessChatMessageById } = await import('./authorization.ts');
