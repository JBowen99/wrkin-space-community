<script lang="ts">
	...
	let showPromoteNotification = $derived(
		form?.success && form.promotedUserId && !promoteDismissed
	);
...
>
	<div class="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
		...
		<code class="mt-1 block break-all font-mono text-sm font-semibold text-blue-900"
