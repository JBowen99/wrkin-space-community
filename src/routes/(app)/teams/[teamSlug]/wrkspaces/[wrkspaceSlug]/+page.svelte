<script lang="ts">
 ...
 import ModulePickerDialog from '$lib/components/module-picker-dialog.svelte';
...
<div>
	...
	<section class="mt-10">
		...
		<ModuleGrid modules={data.modules} {moduleHref} {tier} modulePicker={ModulePickerDialog} />
	</section>
